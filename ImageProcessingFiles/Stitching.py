...
dim = (1024, 768) # new dimensions

# we are resizing images to make sure that they are all the same size, also to make it easier
# for the stitching function to work.
